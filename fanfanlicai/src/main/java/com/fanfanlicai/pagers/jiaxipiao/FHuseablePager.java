...
import com.fanfanlicai.adapter.jiaxipiao.JiaXiPiaoFhUseableAdapter;
...
public class FHuseablePager extends BasePager{

	public FHuseablePager(Context context) {
		super(context);
	...
	protected View initView() {
		...
		// 5.设置adapter
		adapter=new JiaXiPiaoFhUseableAdapter(mContext, list);
		listView.setAdapter(adapter);
		LogUtils.i("可使用的initView");
		return view;
	}
