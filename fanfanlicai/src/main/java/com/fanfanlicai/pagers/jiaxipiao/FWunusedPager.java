...
import com.fanfanlicai.adapter.jiaxipiao.JiaXiPiaoFwUnusedAdapter;
...
public class FWunusedPager extends BasePager{

	public FWunusedPager(Context context) {
		super(context);
	...
	protected View initView() {
		...
		// 5.设置adapter
		adapter=new JiaXiPiaoFwUnusedAdapter(mContext, list);
