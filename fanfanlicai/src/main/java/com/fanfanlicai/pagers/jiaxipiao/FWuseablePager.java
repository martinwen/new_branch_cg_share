...
import com.fanfanlicai.adapter.jiaxipiao.JiaXiPiaoFwUseableAdapter;
...
public class FWuseablePager extends BasePager{

	public FWuseablePager(Context context) {
		super(context);
	...
	protected View initView() {
		...
		// 5.设置adapter
		adapter=new JiaXiPiaoFwUseableAdapter(mContext, list);
