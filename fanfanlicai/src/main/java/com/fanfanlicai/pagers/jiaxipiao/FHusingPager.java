...
import com.fanfanlicai.adapter.jiaxipiao.JiaXiPiaoFhUsingAdapter;
...
public class FHusingPager extends BasePager{

	public FHusingPager(Context context) {
		super(context);
	...
	protected View initView() {
		...
		// 5.设置adapter
		adapter=new JiaXiPiaoFhUsingAdapter(mContext, list);
		listView.setAdapter(adapter);
		LogUtils.i("使用中的initView");
		return view;
	}
