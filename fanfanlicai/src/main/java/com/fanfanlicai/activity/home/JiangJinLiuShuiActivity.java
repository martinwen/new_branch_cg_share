...
import com.fanfanlicai.adapter.fund.JiangJinAdapter;
...
public class JiangJinLiuShuiActivity extends BaseActivity {
	...
	private TextView tv_used;// 已使用奖金
	private TextView tv_unused;// 奖金余额
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_jiangjinliushui);
...
//		String jiangjin_used = CacheUtils.getString(mActivity, CacheUtils.USEDREWARD, "");
//		String jiangjin_unused = CacheUtils.getString(mActivity, CacheUtils.REWARDACCTBAL, "");
//		TextView tv_used = (TextView) view.findViewById(R.id.tv_used);
//		TextView tv_unused = (TextView) view.findViewById(R.id.tv_unused);
//		tv_used.setText(jiangjin_used+"元");//已使用奖金
//		tv_unused.setText(jiangjin_unused+"元");//未使用奖金
	...
	private void initData() {
		// 已使用奖金
		String rewardUsedAmount = CacheUtils.getString(this, CacheUtils.REWARDUSEDAMOUNT, "0.00");
		tv_used.setText("已使用："+rewardUsedAmount+"元");
		// 奖金余额
		String rewardAcctBal = CacheUtils.getString(this, CacheUtils.REWARDACCTBAL, "0.00");
		tv_unused.setText("余额："+rewardAcctBal+"元");
		// 访问网络
		getDataFromServer();
	}
