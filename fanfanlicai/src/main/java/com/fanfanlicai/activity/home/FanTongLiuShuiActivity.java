...
import com.fanfanlicai.adapter.fund.FanTongLiuShuiAdapter;
...
public class FanTongLiuShuiActivity extends BaseActivity {

	private PullToRefreshListView refreshListView;
	private ListView listView;
	private CustomProgressDialog progressdialog;
	private ArrayList<ShouYiBean> list = new ArrayList<ShouYiBean>();
	private FanTongLiuShuiAdapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_fantongliushui);
		tv_fantongzichan = (TextView) findViewById(R.id.tv_fantongzichan);
		//返回
	...
	private void initView() {
		...
		// 4.设置adapter
		adapter = new FanTongLiuShuiAdapter(this, list);
