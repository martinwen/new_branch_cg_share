...
import com.fanfanlicai.adapter.fund.ZhangHuYuEAdapter;
...
public class ZhangHuLiuShuiActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_zhanghuliushui);
		tv_zhanghuyue = (TextView) findViewById(R.id.tv_zhanghuyue);
		//返回
	...
	private void initView() {
		...
		// 5.设置adapter
		adapter = new ZhangHuYuEAdapter(this, list);
		...
		VolleyUtil.sendJsonRequestByPost(ConstantUtils.TRANSLIST_URL,
				null, map, new HttpBackBaseListener() {
					...
					public void onSuccess(String string) {
						...
						LogUtils.longStr("账户余额流水=====" , string);
						if ("0".equals(code)) {
							...
							if (StringUtils.isBlank(datastr)) {
								...
								if (isSuccess) {// 验签成功
									...
									if("-9999".equals(baseAcctBal)){//银行不能正常返回账户余额
										...
										tv_zhanghuyue.setText(baseAcctBal+"元");
									}
