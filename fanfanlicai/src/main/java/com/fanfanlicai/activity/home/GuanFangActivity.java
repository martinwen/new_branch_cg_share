...
import com.fanfanlicai.fragment.guanfang.GongSiFragment;
import com.fanfanlicai.fragment.guanfang.PingTaiFragment;
...
public class GuanFangActivity extends FragmentActivity implements OnClickListener {
	...
	private TextView tv_pingtai, tv_gongsi;//平台公告，公司动态
	...
	private void initView() {
		...
		tv_pingtai = (TextView) findViewById(R.id.tv_pingtai);//饭盒
		tv_gongsi = (TextView) findViewById(R.id.tv_gongsi);//饭碗
	...
	private void initData() {
		...
		// 设置默认文字颜色
		tv_pingtai.setTextColor(getResources().getColor(R.color.global_yellowcolor));
		// 监听ViewPager
	...
	public void onClick(View v) {
		//初始文字颜色为灰色
		tv_pingtai.setTextColor(getResources().getColor(R.color.text_gray));
		tv_gongsi.setTextColor(getResources().getColor(R.color.text_gray));
		switch (v.getId()) {
			...
			case R.id.tv_gongsi:
				...
				tv_gongsi.setTextColor(getResources().getColor(R.color.global_yellowcolor));
				break;
