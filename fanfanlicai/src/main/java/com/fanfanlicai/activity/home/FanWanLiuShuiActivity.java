...
public class FanWanLiuShuiActivity extends BaseActivity {

	private PullToRefreshListView refreshListView;
	private ListView listView;
	private CustomProgressDialog progressdialog;
	private ArrayList<ShouYiBean> list = new ArrayList<ShouYiBean>();
	private FanWanLiuShuiAdapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_fanwanliushui);
		
		tv_fanwanzichan = (TextView) findViewById(R.id.tv_fanwanzichan);
		//返回
	...
	private void initView() {
		...
		// 4.设置adapter
		adapter = new FanWanLiuShuiAdapter(this, list);
