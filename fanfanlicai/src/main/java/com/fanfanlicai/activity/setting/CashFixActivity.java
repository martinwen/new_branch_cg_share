...
import com.fanfanlicai.fragment.setting.CashEmailFragment;
import com.fanfanlicai.fragment.setting.CashPhoneFragment;
import com.fanfanlicai.fragment.totalmoney.TotalmoneyPagerAdapter;
import com.fanfanlicai.utils.CacheUtils;
import com.fanfanlicai.view.HorizontalViewPager;
import com.fanfanlicai.view.dialog.EmailDialog;
...
public class CashFixActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_cash_fix);
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
			...
			case R.id.tv_email:
				...
				if("".equals(email)){
					EmailDialog emailDialog = new EmailDialog(this, R.style.YzmDialog);
					emailDialog.show();
				}else{
