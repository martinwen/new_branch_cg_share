...
public class HuiYuanQuanYiActivity extends BaseActivity implements View.OnClickListener {
    ...
    class NoticeListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            Intent intent = new Intent(HuiYuanQuanYiActivity.this,ZhanNeiXinDetailActivity.class);
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_title:
                ...
                tv_up.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        pop.dismiss();
                        startActivity(new Intent(HuiYuanQuanYiActivity.this,ZhangHuCaoZuoActivity.class));
                        finish();
                    }
                });
                ...
                tv_middle.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        pop.dismiss();
                        startActivity(new Intent(HuiYuanQuanYiActivity.this,TouZiHuiKuanActivity.class));
                        finish();
                    }
                });
                ...
                tv_down.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        pop.dismiss();
                        startActivity(new Intent(HuiYuanQuanYiActivity.this,ZhanNeiXinActivity.class));
                        finish();
                    }
                });
