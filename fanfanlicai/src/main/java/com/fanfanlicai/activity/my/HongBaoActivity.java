...
import com.fanfanlicai.fragment.hongbao.HongBaoUnuseableFragment;
import com.fanfanlicai.fragment.hongbao.HongBaoUseableFragment;
...
public class HongBaoActivity extends FragmentActivity implements OnClickListener {
	...
	private void initData() {
		...
		HongBaoUseableFragment hongBaoUseableFragment = new HongBaoUseableFragment();
		hongBaoUseableFragment.setCode(code);
		fragments.add(hongBaoUseableFragment);

		HongBaoUnuseableFragment hongBaoUnuseableFragment = new HongBaoUnuseableFragment();
		hongBaoUnuseableFragment.setCode(code);
		fragments.add(hongBaoUnuseableFragment);
