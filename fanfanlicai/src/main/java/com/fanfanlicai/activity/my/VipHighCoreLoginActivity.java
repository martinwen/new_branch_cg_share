...
public class VipHighCoreLoginActivity extends BaseActivity implements OnClickListener {
	...
	private TextView tv_youxiangou;//优先购
	private TextView tv_yaoqing;//邀请好友
	private TextView tv_choujiang;//抽奖
	private TextView tv_huiyuanri;//核心会员日
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_viphighcorelogin);
	...
	private void initView() {
		...
		tv_youxiangou = (TextView) findViewById(R.id.tv_youxiangou);//优先购
		tv_yaoqing = (TextView) findViewById(R.id.tv_yaoqing);//邀请好友
		tv_choujiang = (TextView) findViewById(R.id.tv_choujiang);//抽奖
		tv_huiyuanri = (TextView) findViewById(R.id.tv_huiyuanri);//核心会员日
						...
						if ("0".equals(code)) {
							...
							if (StringUtils.isBlank(datastr)) {
								...
								if (isSuccess) {// 验签成功
									...
									// 优先购
									String preferTicketNumDesc = data.getString("preferTicketNumDesc");
									tv_youxiangou.setText(preferTicketNumDesc);
									// 邀请好友投资奖励
									...
									// 打饭
									boolean signable = data.getBoolean("signable");
									// 打饭描述
									String signableDesc = data.getString("signableDesc");
									tv_choujiang.setText(signableDesc);
									// 核心会员日
									String coreUserDayDesc = data.getString("coreUserDayDesc");
									if (coreUserDayDesc.contains("|")) {//   | 表示换行
										String replaceDesc = coreUserDayDesc.replaceAll("\\|", "\n");
										tv_huiyuanri.setText(replaceDesc);
									}else {
										tv_huiyuanri.setText(coreUserDayDesc);
									}
