...
import com.fanfanlicai.fragment.shuhui.FanHeShuHuiFragment;
import com.fanfanlicai.fragment.shuhui.FanTongShuHuiFragment;
import com.fanfanlicai.fragment.shuhui.FanWanShuHuiFragment;
...
public class ShuHuiActivity extends FragmentActivity implements OnClickListener {
	...
	private void initData() {
		...
		fragments.add(new FanHeShuHuiFragment());
		fragments.add(new FanWanShuHuiFragment());
		fragments.add(new FanTongShuHuiFragment());
