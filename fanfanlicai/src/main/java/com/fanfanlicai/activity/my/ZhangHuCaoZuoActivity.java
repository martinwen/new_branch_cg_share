...
public class ZhangHuCaoZuoActivity extends BaseActivity implements View.OnClickListener {
    ...
    class NoticeListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            Intent intent = new Intent(ZhangHuCaoZuoActivity.this,ZhanNeiXinDetailActivity.class);
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_title:
                ...
                tv_up.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        pop.dismiss();
                        startActivity(new Intent(ZhangHuCaoZuoActivity.this,HuiYuanQuanYiActivity.class));
                        finish();
                    }
                });
                TextView tv_middle = (TextView) inflate.findViewById(R.id.tv_middle);
                tv_middle.setText("出借回款");
                tv_middle.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        pop.dismiss();
                        startActivity(new Intent(ZhangHuCaoZuoActivity.this,TouZiHuiKuanActivity.class));
                        finish();
                    }
                });
                ...
                tv_down.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        pop.dismiss();
                        startActivity(new Intent(ZhangHuCaoZuoActivity.this,ZhanNeiXinActivity.class));
                        finish();
                    }
                });
