...
public class ZhanNeiXinActivity extends BaseActivity implements View.OnClickListener {
    ...
    class NoticeListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            Intent intent = new Intent(ZhanNeiXinActivity.this,ZhanNeiXinDetailActivity.class);
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_title:
                ...
                tv_up.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        pop.dismiss();
                        startActivity(new Intent(ZhanNeiXinActivity.this,TouZiHuiKuanActivity.class));
                        finish();
                    }
                });
                TextView tv_middle = (TextView) inflate.findViewById(R.id.tv_middle);
                tv_middle.setText("账户操作");
                tv_middle.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        pop.dismiss();
                        startActivity(new Intent(ZhanNeiXinActivity.this,ZhangHuCaoZuoActivity.class));
                        finish();
                    }
                });
                TextView tv_down = (TextView) inflate.findViewById(R.id.tv_down);
                tv_down.setText("会员权益");
                tv_down.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        pop.dismiss();
                        startActivity(new Intent(ZhanNeiXinActivity.this,HuiYuanQuanYiActivity.class));
                        finish();
                    }
                });
