...
public class FloatDragFanJuView {
    ...
    public static boolean isAdd;//标记是否添加天天饭局悬浮窗
    ...
    public static ImageView addFloatDragView(Activity context , RelativeLayout mViewContainer,
        ...
        FloatDragFanJuView floatDragView = new FloatDragFanJuView(context);
        ImageView imageView = floatDragView.getFloatDragView(clickListener);
        mViewContainer.addView(imageView);
        //外界调用addFloatDragView方法后，添加天天饭局悬浮窗
        isAdd = true;
        return imageView;
    }

    // 初始化实例
    private FloatDragFanJuView(Activity context) {
        setScreenHW(context);
    ...
    private ImageView getFloatDragView(View.OnClickListener clickListener) {
        if (mImageView != null) {
            ...
            mImageView.setImageResource(R.drawable.fanju_icon);
            ...
            public boolean onTouch(final View v, MotionEvent event) {
                ...
                switch (action) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        if (bottom > mScreenHeight- LockPatternUtil.dip2px(context,50)) {
                            bottom = mScreenHeight- LockPatternUtil.dip2px(context,50);
