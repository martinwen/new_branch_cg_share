package com.fanfanlicai.view.password;
...
import com.fanfanlicai.view.password.ImeDelBugFixedEditText;
...
//        mLineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_gpvLineWidth, Util.dp2px(getContext(), 1));
        mLineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_gpvLineWidth, 1);
