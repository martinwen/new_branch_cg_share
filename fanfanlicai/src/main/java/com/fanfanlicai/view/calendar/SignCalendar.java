...
public class SignCalendar extends LinearLayout {
    ...
    private void initTitleView() {
        ...
        LogUtils.i("leftArrowClick==="+leftArrowClick);
        ...
        //修改颜色为全局色
        titleContent.setTextColor(mContext.getResources().getColor(R.color.global_yellowcolor));
...
//        titleContent.setTextSize(TypedValue.COMPLEX_UNIT_PX, mContext.getResources().getDimension(R.dimen.cal_title_text_size));
    ...
    private void addDivider() {
        ...
        //修改颜色为全局色
        divider.setBackgroundColor(mContext.getResources().getColor(R.color.global_yellowcolor));
