package com.fanfanlicai.view.tupian;
...
import com.fanfanlicai.view.tupian.photoView.PhotoView;
import com.fanfanlicai.view.tupian.photoView.PhotoViewAttacher;
...
public class PicShowDialog extends Dialog {
    ...
    private DisplayImageOptions optionsImag = new DisplayImageOptions.Builder()
            .showImageForEmptyUri(R.drawable.head_out)
            .showImageOnFail(R.drawable.head_out).cacheInMemory(true).cacheOnDisk(true)
