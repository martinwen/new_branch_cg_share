...
public class FanTongLiuShuiAdapter extends BaseAdapter {

	private ArrayList<ShouYiBean> list;
	private Context mContext;

	public FanTongLiuShuiAdapter(Context context, ArrayList<ShouYiBean> list) {
		super();
		this.mContext = context;
		this.list = list;
	}

	public FanTongLiuShuiAdapter(Context context) {
		super();
		this.mContext = context;
	}
