...
public class ShuHuiAdapter extends BaseAdapter {

	private ArrayList<ShuHuiBean> list;
	private Context mContext;
	public ShuHuiAdapter(Context context, ArrayList<ShuHuiBean> list) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(mContext, R.layout.items_shuhui, null);
