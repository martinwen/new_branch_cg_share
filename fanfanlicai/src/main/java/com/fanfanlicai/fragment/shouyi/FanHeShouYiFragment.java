...
public class FanHeShouYiFragment extends BaseFragment{
	...
	protected View initView() {
		...
		View view = View.inflate(mActivity, R.layout.fragment_fanheshouyi, null);
	...
	public void initData() {
		//饭盒累计收益
		String fhTotalIncome = CacheUtils.getString(mActivity, CacheUtils.FHTOTALINCOME, "0.00");
