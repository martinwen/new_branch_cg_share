...
public class FanWanShouYiFragment extends BaseFragment{
	...
	protected View initView() {
		...
		View view = View.inflate(mActivity, R.layout.fragment_fanwanshouyi, null);
	...
	public void initData() {
		//饭碗累计收益
		String fwTotalIncome = CacheUtils.getString(mActivity, CacheUtils.FWTOTALINCOME, "0.00");
