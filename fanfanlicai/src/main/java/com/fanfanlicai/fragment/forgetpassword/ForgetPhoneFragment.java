...
public class ForgetPhoneFragment extends BaseFragment implements View.OnClickListener,TextWatcher {
    ...
    protected View initView() {
        ...
        View view = View.inflate(mActivity, R.layout.fragment_forgetphone, null);
        ...
        et_phone = (EditText) view.findViewById(R.id.et_phone);//手机号输入框
        ...
        et_mima_confirm.setTransformationMethod(PasswordTransformationMethod
                .getInstance());
        ed_code = (EditText) view.findViewById(R.id.ed_code);//密码输入框
        ...
        rl_shownumber = (RelativeLayout) view.findViewById(R.id.rl_shownumber);// 验证码已发送至xxx号码
        tv_phone = (TextView) view.findViewById(R.id.tv_phone);// 注册手机号
        iv_cancel = (ImageView) view.findViewById(R.id.iv_cancel);// 手机号码后面的取消按钮
...
//                    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_yanzhengma:// 短信验证码
                ...
                checkPhone(phonenumber,0);

                break;
            case R.id.tv_yuyin://语音验证码
                ...
                new HttpBackBaseListener() {
                    ...
                    public void onSuccess(String string) {
                        ...
                        if("0".equals(code)){
                            ...
                            CacheUtils.putString(mActivity, CacheUtils.LOGINPHONE,phonenumber);
    ...
    private void getcode(final int type) {
        YzmDialog yzmDialog = new YzmDialog(mActivity, R.style.YzmDialog, phonenumber);
        yzmDialog
