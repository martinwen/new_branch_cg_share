...
public class ProjectInfoFragment extends BaseFragment {
    ...
    protected View initView() {
        View view = View.inflate(mActivity, R.layout.fragment_projectinfo, null);
    ...
    public void initData() {
        ...
        {
            mUrl = ConstantUtils.PROJECTINTROZT_URL;
        } else {
            mUrl = ConstantUtils.PROJECTINTROFW_URL;
        }
        try {
    ...
    private void initwebview() {
        ...
        //与webview交互
        mWebview.addJavascriptInterface(new ProjectInfoFragment.JavaScriptInterface(), "fanfan");
